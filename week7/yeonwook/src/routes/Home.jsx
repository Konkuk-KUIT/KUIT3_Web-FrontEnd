...
const Home = () => {
  ...
  return (
    <>
    <ImageWrap><img src={reactIcon} alt=""/></ImageWrap>
      <StyledH1 Color={Color}>홈</StyledH1>
      <Header />
      <StyledP>이 편지는 영국에서 최초로 시작되어 일년에 지구를 한 바퀴 돌면서 받는 사람에게 행운을 주었고
        ...
        며칠 뒤에 복권에 당첨되어 20억을 받았습니다. 어떤 이는 이 편지를 받았으나 96시간 이내 자신의 손에서 떠나야 한다는 사실을 잊었습니다.
        ...
        이 편지는 영국에서 최초로 시작되어 일년에 지구를 한 바퀴 돌면서 받는 사람에게 행운을 주었고
        지금 당신에게로 옮겨진 이 편지는 4일 안에 당신 곁을 떠나야 합니다.
        이 편지를 포함해서 7통을 행운이 필요한 사람에게 보내 주셔야 합니다.
        복사를 해도 좋습니다. 혹 미신이라 하실지 모르지만 사실입니다.
        영국에서 HGXWCH이라는 사람은 1930년에 이 편지를 받았습니다. 그는 비서에게 복사해서 보내라고 했습니다.
